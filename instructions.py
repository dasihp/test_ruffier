txt_instruction = '''
Ця програма дозволить вам за допомогою тесту Руфье \n провести первинну діагностику вашого здоровʼя.\n
Тест Руф'є є навантажувальним комплексом, \n призначеним для оцінки працездатності Вашого серця під час фізичного 
навантаження.\n
